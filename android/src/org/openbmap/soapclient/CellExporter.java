...
public class CellExporter {
	...
	/**
	 * MCC code for filename generation, this is generated by looking at the first cell
	 */
	private String	mFileMcc;
	...
	protected final ArrayList<String> export() {
		...
		mFileMcc = determineFileMcc(cursorCells);
		...
		while (!cursorCells.isAfterLast()) {
			...
			while (!cursorCells.isAfterLast()) { 
				...
				String fileName  = mTempPath + generateFilename(mFileMcc, fileTimeStamp);
	...
	/**
	 * Gets MCC information from first record
	 * @param cursor
	 * @return
	 */
	private String determineFileMcc(Cursor cursor) {
		// get infos for generating filename, basically mcc
		if (cursor.moveToFirst()) {
			String mcc = cursor.getString(colMcc);
