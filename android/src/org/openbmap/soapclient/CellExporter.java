...
public class CellExporter {
	...
	protected final ArrayList<String> export() {
		...
		if (cursorCells.moveToFirst()) {
			fileMcc = cursorCells.getString(colMcc);
			fileTimeStamp = cursorCells.getLong(colReqTimestamp);
		...
		while (!cursorCells.isAfterLast()) {
			...
			while (!cursorCells.isAfterLast()) { 
				...
				Log.i(TAG, "Cycle " + i);
				String fileName  = mTempPath + generateFilename(mUser, fileMcc, fileTimeStamp);
	 ...
	 * @return filename
	 */
	private String generateFilename(final String user, final String mcc, final long timestamp) {	
		/**
