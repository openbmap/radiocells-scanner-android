...
import org.openbmap.services.blacklists.LocationBlackList;
import org.openbmap.services.blacklists.SsidBlackList;
...
public class WifiScannerService extends Service {
     ...
     * WifiLock tag
     */
    private static final String WIFILOCK_NAME = "WakeLock.WIFI_OBJECT";
    ...
    private CatalogStatus checkCatalogStatus(final String bssid) {
        ...
        try {
			 ...
			 */
            final Cursor exists = wifiCatalog.rawQuery("SELECT bssid, source FROM wifis WHERE bssid = ?",
                    new String[]{bssid.replace(":", "").toUpperCase()});
