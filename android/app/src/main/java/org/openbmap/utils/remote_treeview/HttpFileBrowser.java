...
public class HttpFileBrowser {
		...
		*/
        ...
        try {
            ...
            if (http.getContentType() != null) {
                if ("text/html".equals(http.getContentType()) || http.getContentType().startsWith("text/html" + ";")) {
                    if (!isTypeKnown)
                        isDirectory = true; // best guess, hence isTypeKnown remains false
                } else {
                    isTypeKnown = true;
    ...
    public static RemoteFile[] list(String urlStr) {
        ...
        try {
            ...
            if ((http.getContentType() == null) || (!"text/html".equals(http.getContentType()) && !http.getContentType().startsWith("text/html" + ";")))
