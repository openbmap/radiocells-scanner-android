...
public class ContentProvider extends android.content.ContentProvider {
     ...
     * Can be appended to certain URIs to get only items of active session
     */
    public static final String CONTENT_URI_UNKNOWN_SUFFIX = "unknown";
    ...
    static {
        ...
        uriMatcher.addURI(AUTHORITY, Schema.TBL_WIFIS + "/" + CONTENT_URI_OVERVIEW_SUFFIX + "/" + CONTENT_URI_UNKNOWN_SUFFIX, Schema.URI_CODE_WIFIS_UNKNOWN);
     ...
     */
    @Override
    public final Cursor query(final Uri uri, final String[] projection, String where,
                              String[] criteria, String sortOrder) {
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case Schema.URI_CODE_WIFIS_EXTENDED: {
                ...
                return queryTable(ContentProvider.CONTENT_URI_WIFI_EXTENDED,
                        Schema.VIEW_WIFIS_EXTENDED,
                        projection,
                        where,
                        criteria,
                        sortOrder,
            ...
            case Schema.URI_CODE_CELLS_EXTENDED: {
                // Returns all wifis including position data
                return queryTable(ContentProvider.CONTENT_URI_CELL_EXTENDED,
                        Schema.VIEW_CELLS_EXTENDED,
                        projection,
                        where,
                        criteria,
                        sortOrder,
            ...
            case Schema.URI_CODE_WIFI_OVERVIEW: {
                ...
                String table = Schema.TBL_WIFIS + " as w "
            ...
            case Schema.URI_CODE_WIFIS_UNKNOWN: {
                /**
                 *  returns all new wifis (from all sessions)
                 *  if several measurements for specific wifi bssid are available only strongest
                 *  measurement (criteria level) is returned
                 *  @author http://stackoverflow.com/questions/3800551/sql-select-first-row-in-each-group-by-group
                 */
                ...
                return queryTable(uri,
                        table,
                        columns,
                        extendWhereBy("w." + Schema.COL_KNOWN_WIFI, where),
                        extendCriteriaBy("0", criteria),
                        sortOrder,
                        groupBy,
                        null);
            }
            case Schema.URI_CODE_WIFI_ID: {
                ...
                return queryTable(ContentProvider.CONTENT_URI_WIFI,
                        ...
                        extendWhereBy(Schema.COL_ID, where), extendCriteriaBy(uri.getLastPathSegment(), criteria),
                        sortOrder,
                        null,
                        null);
            }
            case Schema.URI_CODE_WIFIS_BY_SESSION: {
                ...
                return queryTable(ContentProvider.CONTENT_URI_WIFI,
                        Schema.TBL_WIFIS,
                        projection,
                        extendWhereBy(Schema.COL_SESSION_ID, where),
                        extendCriteriaBy(uri.getLastPathSegment(), criteria),
                        sortOrder,
                        null,
                        null);
            ...
            case Schema.URI_CODE_CELLS: {
                ...
                return queryTable(ContentProvider.CONTENT_URI_CELL,
                        Schema.TBL_CELLS,
                        projection,
                        where,
                        criteria,
            ...
            case Schema.URI_CODE_CELL_OVERVIEW: {
                ...
                String table = Schema.TBL_CELLS + " as c "
                        + " JOIN " + Schema.TBL_POSITIONS + " as b ON " + Schema.COL_BEGIN_POSITION_ID + " = b." + Schema.COL_ID;
                ...
                criteria = new String[]{uri.getLastPathSegment(), "-1"};

                sortOrder = Schema.COL_IS_SERVING + " DESC";
                String groupBy = "c." + Schema.COL_LOGICAL_CELLID + ", "
                        + Schema.COL_PSC + ", " + Schema.COL_CDMA_SYSTEMID + ", "
                        + Schema.COL_CDMA_NETWORKID + ", "
                        + Schema.COL_CDMA_BASEID + ", "
                        + Schema.COL_IS_SERVING;
            ...
            case Schema.URI_CODE_CELL_ID: {
                ...
                return queryTable(ContentProvider.CONTENT_URI_CELL,
                        Schema.TBL_CELLS,
                        projection,
                        extendWhereBy(Schema.COL_ID, where),
                        extendCriteriaBy(uri.getLastPathSegment(), criteria),
                        sortOrder,
                        null,
                        null);
            ...
            case Schema.URI_CODE_POSITIONS: {
                ...
                return queryTable(ContentProvider.CONTENT_URI_POSITION,
                        Schema.TBL_POSITIONS,
                        projection, where, criteria, sortOrder,
                        null,
                        null);
            }
            ...
            case Schema.URI_CODE_WAYPOINTS_BY_SESSION: {
                ...
                String column = extendWhereBy(Schema.COL_SESSION_ID, where);
                String[] args = extendCriteriaBy(uri.getLastPathSegment(), criteria);
                return queryTable(ContentProvider.CONTENT_URI_POSITION,
                        Schema.TBL_POSITIONS,
                        projection,
            ...
            case Schema.URI_CODE_LOGS_BY_SESSION: {
                ...
                return queryTable(ContentProvider.CONTENT_URI_LOGFILE,
                        Schema.TBL_LOGS,
                        projection,
                        extendWhereBy(Schema.COL_SESSION_ID, where),
                        extendCriteriaBy(uri.getLastPathSegment(), criteria),
            ...
            case Schema.URI_CODE_SESSIONS: {
                ...
                return queryTable(ContentProvider.CONTENT_URI_SESSION,
                        Schema.TBL_SESSIONS,
                        projection, where, criteria, sortOrder, null, null);
            }
            case Schema.URI_CODE_SESSION_ID: {
                return queryTable(ContentProvider.CONTENT_URI_SESSION,
                        Schema.TBL_SESSIONS,
                        projection, extendWhereBy(Schema.COL_ID, where),
                        extendCriteriaBy(uri.getLastPathSegment(), criteria),
                        sortOrder,
                        null,
                        null);
            ...
            case Schema.URI_CODE_SESSION_ACTIVE: {
                return queryTable(ContentProvider.CONTENT_URI_SESSION,
                        Schema.TBL_SESSIONS,
                        projection,
                        extendWhereBy(Schema.COL_IS_ACTIVE, where),
                        extendCriteriaBy("1", criteria),
                        sortOrder,
                        null,
                        null);
            }
     ...
     */
    private String extendWhereBy(final String colName, final String selectionIn) {
     ...
     * @return
     */
    private String[] extendCriteriaBy(final String argValue, final String[] selectionArgsIn) {
    ...
    public final int update(final Uri uri, final ContentValues values,
        ...
        switch (uriMatcher.match(uri)) {
            ...
            case Schema.URI_CODE_SESSION_ID:
                return updateTable(uri, Schema.TBL_SESSIONS, values, extendWhereBy(Schema.COL_ID, selectionIn), extendCriteriaBy(uri.getLastPathSegment(), selectionArgsIn));
            case Schema.URI_CODE_WIFIS:
